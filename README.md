...
<script>
  ...
  gtag('config', 'UA-162866202-1');
    ...
    <title> Atharv Shukla </title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="utf-8">
    <meta name="description" content="Online portfolio showcasing work-experience, education, skills and achievements of Atharv Shukla, an aspiring Software Developer">
    <meta name="author" content="Atharv Shukla">
    <meta name="keywords"   content="resume, product management, development, testing, marketing, analytics, mentor, instructor,Portfolio,">
    <meta property="og:title" content="Atharv Shukla's Portfolio">
    <meta property="og:type" content="website">
    
    <meta property="og:description" content="Online portfolio showcasing work-experience, education, skills and achievements of Atharv Shukla , an aspiring web devloper">
    <meta property="og:image" content="">
    <meta property="og:locale" content="en_IN" />
    <link rel="stylesheet" href="./style.css">
    <link rel="icon" type="image/png" href="">

    <script data-ad-client="ca-pub-5739573321359675" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    ...
    <div class="container">
      <header class="col-full">
        ...
        <div class="title">
          ...
          <h1>Atharv Shukla
            <small>Blockchain Devlopment | Web Development </small>
          </h1>
        </div>
        ...
        <nav id="navbar">  
          <ul>
            ...
            <li id="resumeLink"><a href="" href="{{.}}" target="_blank" title="Résumé English (UK)">View Résumé 📄</a></li>

          </ul>
        </nav>
        <nav2 id="navbar2" class="shown" >  
          <ul>
          <li id="ConsoleLink" style=" margin-right: 40% ;" ><a href="">> $ cd /home/
            ...
            <li id="resumelink"><a href="" href="{{.}}" target="_blank" title="Résumé English (UK)">View Résumé (PDF) 📄</a></li>
          </ul>
        </nav2>
      </header>
        ...
        <div class="col-full">
          <div class="flex-container">
            <div class="flex-media-obj">
              <img src="profile.jpeg" class="profile-picture">
            </div>
            <div class="flex-fill">
              <h1>Atharv Shukla
              ...
              <a href="mailto:atharvshukla.dev@gmail.com?Subject=Regarding Online Resume" target="_blank" class="social-icon" title="Email"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                <polyline points="22,6 12,13 2,6"></polyline>
              </svg></a>
              <a href="https://www.linkedin.com/in/atharv-shukla-634419171/" target="_blank" class="social-icon" title="LinkedIn"><svg xmlns="http://www.w3.org/2000/svg"  width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
                <rect x="2" y="9" width="4" height="12"></rect>
                <circle cx="4" cy="4" r="2"></circle>
              </svg></a>
            <a href="https://github.com/Atharvshukla" target="_blank" class="social-icon" title="GitHub"><svg xmlns="http://www.w3.org/2000/svg"  width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <p>Hey  I'm Atharv Shukla, <strong>Btech Student in VIT Vellore</strong>. 
           Understanding Programming and CS fundamentals is not just a career path for me, but also a passion of mine.
            I like to build<strong> Web-apps,Dapps </strong> I Really love to contribute in open source  and various communities of students. I Secured a Rank of <strong>282/22578</strong> in July long challenge by <strong>Codechef</strong>. I am into devlopment from very young age i.e 15 devloping web applications, Dapps in Etherum blockchain and basic android apps. always eager to learn new Technologies and CS fundamentals.  </p>
         

         

            <strong> My skills include :</strong> <span> C++, CSS, JavaSript, Solidity, MySql .  </span>
      ...
      <section class="col-centered container" id="education">
        <div class="col-full">
          ...
          <div class="flex-container">
            <div class="flex-media-logo">
              <img src="./assets/kps.png">
            </div>
            <div class="flex-title">
              <h3>Senior Secondary Education- XII (CBSE) 👨‍⚖️
                <small>Krishna Public School Koni, Bilaspur</small>
                <small>86.8%</small>
          ...
          <div class="flex-container">
            ...
            <div class="flex-title">
              <h3>Secondary Education- X (CBSE) 👨‍⚖️
                <small>Krishna Public School Sarona, Raipur</small>
                <small>84.5%</small>
      ...
      <section class="col-centered container" id="projects">
        <div class="col-full">
          ...
          <div class="flex-container">
            ...
            <div class="flex-title">
              <h3>Interactive Resume Website <a href="" target="_blank"><img src="./assets/link-external.svg"></a>
          ...
          <div class="content-left-offset">
            <p>Mobile responsive online portfolio showcasing my Resume,
              education, projects and achievements along with mailing service. </p>
          </div>
          ...
          <div class="flex-container">
            ...
            <div class="flex-title">
              <h3>Dappstragram <a href="https://youtu.be/wq3HQqQrJpo" target="_blank"> <img src="./assets/link-external.svg"></a>
                <small>JavaScript, CSS, HTML, Solidity, Web3js, Truffle, Chaijs</small>
                
              </h3>
            </div>
          </div>
              <div class="content-left-offset">
                <p> Blockchain Based Decentralised Social Networking Dapp devloped on Truffle Framework also alowing to Tip the post's instead liking.</p>
              </div>
          
          
          <div class="flex-container">
            <div class="flex-media-logo">
              <img src="./assets/ocv.jpg">
            </div>
            <div class="flex-title">
              <h3>Number Sign Recognition System<a href="https://github.com/Atharvshukla/number-sign-recognition-system" target="_blank"><img src="./assets/link-external.svg"></a>
                <small>Python 3, openCV, keras, CNN</small>
               
              </h3>
            </div>
          </div>
          <div class="content-left-offset">
            <p>A small project allowing to recognize the numbers and signs using Convolutional Neural Network(CNN) an image classifier in openCV and keras.</p>
          </div>
        ...
        <div class="col-full">
          ...
          <div class="content-left-offset2">
            ...
            <ul>
              ...
              <li>  Secured a Rank of 282/22578 in July long challenge by Codechef .</li>
          ...
          <div class="content-left-offset2"><strong>PROFESSIONAL SKILLS :</strong>
            <ul>
              <li>C++ and Python 3</li>
             
              <li> Truffle and Solidity</li>
              <li>HTML, CSS, JavaScript</li>

              <li>OpenCV, keras, CNN</li>
        ...
        <div class="col-full">
          <h2>Contact Me ✍️</h2>
           ...
           <div >
            ...
            <p>
              <span>I am <strong> always looking for new interesting career opportunities </strong> across roles and functions in Product Management and Freelance jobs. 
      ...
      <footer class="col-full container">
        <div class="col-centered">
          ...
          <p>Developed  by <a href="" target="_blank">Atharv Shukla</a>  <br>
